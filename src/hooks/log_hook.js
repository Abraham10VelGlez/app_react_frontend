...
/*
    const handleAfterToast = (url_session, tik, idx, namez, emailx) => {
        ...
        ///activando la session de Contexto GLOBAL PARA TODO EL SISTEMA POR USUARIO        
        clearUser()
        setUser({ id: idx, name: namez, email: emailx });
